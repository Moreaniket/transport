...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Use Path object for compatibility
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER')  # Secure email
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # Secure password
